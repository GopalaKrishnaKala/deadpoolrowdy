...
if entry_airport == 'AUS':
    ...
    df_sfo.head()
elif entry_airport == 'SLC':
    df_slc = pd.read_csv("updated_flight_data_and_price_history_SLC_to_SAT.csv")
